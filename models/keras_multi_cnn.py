...
class KerasMultiCNNModel(BaseModel):
    def __init__(self):
        ...
        #self.label_groups[1] = ['artisinal_mine', 'conventional_mine', 'habitation']
        #self.label_groups[2] = ['blooming', 'blow_down', 'slash_burn']
        #self.label_groups[3] = ['road', 'selective_logging', 'water']
        #self.label_groups[4] = ['agriculture', 'cultivation']
        #self.label_groups[5] = ['clear', 'cloudy', 'haze', 'partly_cloudy']

        #Low-correlated labels partitioning
        self.label_groups[0] = ['agriculture', 'artisinal_mine', 'blow_down', 'water']
        self.label_groups[1] = ['bare_ground', 'blooming', 'road']
        self.label_groups[2] = ['clear', 'haze', 'partly_cloudy' ]
        self.label_groups[3] = ['cloudy', 'conventional_mine', 'primary']
        self.label_groups[4] = ['cultivation', 'selective_logging']
        self.label_groups[5] = ['habitation', 'slash_burn']
